...
const context = { DISPLAY_GROUP_COMMUNITY_STATS_RPC: "get_display_group_community_stats", state, buildDisplayGroupCommunityStatsRequest: () => ["narkobetjenten"], normalizeText: String, parseNumber: Number, Math, Object, refreshOpenPodcastDetailSheet: () => {}, console: { warn() {} } };
